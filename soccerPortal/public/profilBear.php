...
?>
	...
	?>
		...
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Ja, meinen Freundne soll angezeigt werden, dass ich online bin.</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Nein, meinen Freunden soll nicht angezeigt werden, dass ich online bin</p>
		
		<p>Wollen Sie die Shoutbox angezeigt bekommen?</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Ja, die Shoutbox soll angezeigt werden</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Nein, die Shoutbox soll nicht angezeigt werden </p>
		
		<p>Wollen Sie per Email benachrichtigt werden, wenn Sie ein neue Nachricht im Spiel bekommen haben?</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Ja, ich m&ouml;chte benachrichtigt werden</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Nein, ich m&ouml;chte nicht benachrichtigt werden </p>
		
		<p>M&ouml;chten Sie den Newsletter empfangen um aktuelle Informationen zum Spiel geschehen und neuerungen erhalten?</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Ja, ich m&ouml;chte den Newsletter erhalten</p>
		<p><input type="checkbox" name="msg[1]" id="msg1393" value="1393">Nein, ich m&ouml;chte den Newsletter nicht erhalten </p>
